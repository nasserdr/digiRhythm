...
The user does not need worry about looping over days, extract the lomb scargle periodogram for every 7 days and then compile the results to obtain the degree of functional coupling. This is done in loop inside the dfc function. However, the
...
```{r lsp}
#df <- data[, activity]
#lomb_scargle_periodogram(df, alpha = 0.01, plot = TRUE)
```
