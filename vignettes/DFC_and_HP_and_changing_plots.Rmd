...
```{r dfc_hp}
my_dfc <- dfc(data, # The dataset which first column is the datetime in posix and the subsequent columns are numeric activities
              activity = activity, # the name of the activity column
              sampling = 15, # the sampling frequency of my dataset is 15
              alpha = 0,5, # consider frequency peaks with higher than 0.5 p-value as significant
              harm_cutoff = 12, # consider up till the harmonic 24/12 which is two hours
