...
DigiRhythm additionally contains some deeper visualisation possibilities.
    - the function daily_activity_wrap_plot could be used to visualise the activity over time per day
