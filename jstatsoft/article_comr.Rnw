...
=======
The welfare of farm animals is a growing concern to the public, yet indicators that allow to reliably quantify the welfare of these animals are scarce. One method that has been proposed to serve this purpose is measuring the organisms rhythmicity from activities acquired with sensors (e.g., accelerometers). The Degree of Functional Coupling (DFC) is one of these rhythmicity indicators. Computing the DFC involves several computational steps, such as computing a frequency spectrum and determining the statistical significance of its peaks. Additionally, categorizing the significant peaks in frequencies that are harmonically synchronised with the periodicity of the environment. In this paper, we present the \proglang{R} package \pkg{digiRhythm}, which provides functions that allow calculating rhythmicity from activity data. Further, additional functions, such as creating actograms, computing and visualizing average activities, and the calculation of a diurnality index are also integrated in this package. The package is customized for integration in the research workflow, from raw data to creating publication-ready content and therefore allows the simple application of these sophisticated methods.
>>>>>>> ae51b0de82954ce0394bcbda2b58b31d30577b55
}
...
\section[Introduction: The Degree of Functional Coupling in the context of livestock production ]{Introduction: The Degree of Functional Coupling in the context of livestock production} \label{sec:intro}
...
suggest to delete start:
With the progression of digital technologies livestock production has changed significantly. Sensors are now regularly mounted on animals, with the intention of improving management practices through monitoring performance, such as daily milk yields. However, existing sensor systems are also used for the early detection of physiological changes. To date, the reliability of sensor based abnormality detection still proves potential for optimization. While processes on farms, including livestock production, are increasingly automated, it is still not possible to reliably assess the welfare state of a farm animals. The Degree of functional coupling (DFC) presents a unique approach to activity evaluation. The DFC is a metric used to describe the extent to which a measured activity is significantly cyclic to 24 hours and thus harmonically synchronized with the periodicity of the environment. Such activity can be, e.g., the number of steps during a time interval or an acceleration measured with an accelerometer mounted on the animal, but could also be the visiting times of feeding troughs or watering stations. It is assumed that organisms in a good welfare state have a rhythmicity close to 1, whereas the rhythmicity of the organism drops when its physiological state is compromised. The DFC was first introduced by \cite{sinz1976systemanalyse} to gain insight into the circadian rhythm of sheep. Hereby, the authors confirmed that the DFC of sheep dropped before they died.  \cite{scheibe1999comparative} further used the  DFC to evaluate the welfare of zoo animals and wildlife by applying a sequence of mathematical operations on continuous signals collected via animal-borne sensors.
suggest to delete end:
...
Digitalisation has reached livestock farming and sensors are now regularly mounted on animals with the intention of improving management through early detection of physiological abnormalities. To date, the reliability of sensor based abnormality detection still proves potential for optimization. The Degree of functional coupling (DFC) presents a unique approach to activity evaluation. The DFC is a metric used to describe the extent to which a measured activity is significantly cyclic to 24 hours and thus harmonically synchronized with the periodicity of the environment. Such activity can be, e.g., the number of steps during a time interval or an acceleration measured with an accelerometer mounted on the animal, but could also be the visiting times of feeding troughs or watering stations. The DFC was first introduced by \cite{sinz1976systemanalyse} to gain insight into the circadian rhythm of sheep and used by \cite{scheibe1999comparative} to evaluate the welfare of zoo animals and wildlife by applying a sequence of mathematical operations on continuous signals collected via animal-borne sensors. With the increasing availability of sensor systems to collect behavioral data continuously, more studies applying the DFC were performed \citep{sarout2018assessment, fuchs2022detecting}. These studies were able to demonstrate that the rhythm of animals is linked to their state of physical well being. However, the application of the DFC was always limited to those with extensive knowledge of statistical programming. An open source package specifically for this type of computation opens up the opportunities for livestock research to easily apply these algorithms. Therefore, we developed the \proglang{R} package \pkg{digiRhythm} \citep{dgm}.
=======
Digitalisation has reached livestock farming and sensors are now regularly mounted on animals with the intention of improving management through early detection of physiological abnormalities. To date, the reliability of sensor based abnormality detection still proves potential for optimization. The Degree of functional coupling (DFC) presents a unique approach to activity evaluation. The DFC is a metric used to describe the extent to which a measured activity is significantly cyclic to 24 hours and thus harmonically synchronized with the periodicity of the environment. Such activity can be, e.g., the number of steps during a time interval or an acceleration measured with an accelerometer mounted on the animal, but could also be the visiting times of feeding troughs or watering stations. The DFC was first introduced by \cite{sinz1976systemanalyse} to gain insight into the circadian rhythm of sheep and used by \cite{scheibe1999comparative} to evaluate the welfare of zoo animals and wildlife by applying a sequence of mathematical operations on continuous signals collected via animal-borne sensors. With the increasing availability of sensor systems to collect behavioral data continuously, more studies applying the DFC were performed \citep{sarout2018assessment, fuchs2022detecting}. These studies were able to demonstrate that the rhythm of animals is linked to their state of physical well being. However, the application of the DFC was always limited to those with extensive knowledge of statistical programming. An open source package specifically for this type of computation opens up the opportunities for livestock research to easily apply these algorithms. Therefore, we developed the \proglang{R} package \pkg{digiRhythm} \citep{dgm}.
>>>>>>> ae51b0de82954ce0394bcbda2b58b31d30577b55
